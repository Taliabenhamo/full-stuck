...
myQuestions.forEach((question) => {
  ...
  <div class="answer-1">
  <input type="radio" id="answer-a" name="answern1" value="firstanswer">${question.answer1}</input><br>
  </div>
  
  <div class="answer-2">
  
  <input type="radio" id="answer-b" name="answern2" value="secondanswer">${question.answer2}</input><br>
  </div>
  
  <div class="answer-3">
  <input type="radio" id="answer-c" name="answern3" value="thirdanswer">${question.answer3}</input><br>
